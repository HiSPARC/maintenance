...
* The historgrams for my station don't look correct, how can I adjust the station settings to fix this?
   - Read here about `calibrating the detectors <http://hisparc.github.io/station-software/doc/configuratie.html#calibratie-van-de-detector>`_
...
* Where can I find the documentation for a certain part of the software or hardware?
   - On this page there is an overview of all our documentation pages: `HiSPARC docs <http://hisparc.github.io/>`_
